...
/* 0 */		{ .entry = &syscall_restart_syscall },
		...
		{ .entry = &syscall_read },
		{ .entry = &syscall_write },
/* 5 */		{ .entry = &syscall_ni_syscall }, //{ .entry = &syscall_open },
		{ .entry = &syscall_close },
...
/* 15 */	{ .entry = &syscall_chmod },
		...
		{ .entry = &syscall_ni_syscall },		/* was sys_stat */
                { .entry = &syscall_ni_syscall }, //{ .entry = &syscall_lseek },
/* 20 */	{ .entry = &syscall_getpid },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_mount },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_dup },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_pipe },
		{ .entry = &syscall_times },
...
/* 50 */	{ .entry = &syscall_getegid16 },
		{ .entry = &syscall_acct },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_umount },
...
/* 60 */	{ .entry = &syscall_umask },
		...
		{ .entry = &syscall_ustat },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_dup2 },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_swapon },
...
/* 110 */	{ .entry = &syscall_ni_syscall },		/* was sys_iopl */
		...
		{ .entry = &syscall_wait4 },
/* 115 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_swapoff },
		{ .entry = &syscall_sysinfo },
                { .entry = &syscall_ni_syscall }, /* was sys_ipc, OBSOLETE */
		{ .entry = &syscall_fsync },
		{ .entry = &syscall_sigreturn },
/* 120 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_clone },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_sched_setscheduler },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_mremap },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_prctl },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_setxattr },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_lsetxattr },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_fsetxattr },
...
/* 240 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_futex },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_epoll_ctl },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_socket },
		{ .entry = &syscall_bind },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_send },
/* 290 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_sendto },
		{ .entry = &syscall_recv },
		{ .entry = &syscall_recvfrom },
		{ .entry = &syscall_shutdown },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_setsockopt },
/* 295 */	{ .entry = &syscall_getsockopt },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_sendmsg },
		{ .entry = &syscall_recvmsg },
		{ .entry = &syscall_semop },
		{ .entry = &syscall_semget },
/* 300 */	{ .entry = &syscall_semctl },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_msgsnd },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_msgrcv },
		{ .entry = &syscall_msgget },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_msgctl },
/* 305 */	{ .entry = &syscall_shmat },
		{ .entry = &syscall_shmdt },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_shmget },
		{ .entry = &syscall_shmctl },
		{ .entry = &syscall_add_key },
/* 310 */	{ .entry = &syscall_request_key },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_keyctl },
...
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_inotify_add_watch },
		{ .entry = &syscall_inotify_rm_watch },
		{ .entry = &syscall_mbind },
/* 320 */	{ .entry = &syscall_get_mempolicy },
		{ .entry = &syscall_set_mempolicy },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_openat },
...
/* 335 */	{ .entry = &syscall_pselect6 },
		{ .entry = &syscall_ppoll },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_unshare },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_set_robust_list },
		{ .entry = &syscall_get_robust_list },
/* 340 */	{ .entry = &syscall_splice },
		{ .entry = &syscall_sync_file_range2 },
		{ .entry = &syscall_tee },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_vmsplice },
...
/* 350 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_timerfd_create },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_eventfd },
		{ .entry = &syscall_fallocate },
		{ .entry = &syscall_timerfd_settime },
		{ .entry = &syscall_timerfd_gettime },
/* 355 */	{ .entry = &syscall_signalfd4 },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_eventfd2 },
		{ .entry = &syscall_epoll_create1 },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_dup3 },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_pipe2 },
...
/* 370 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_name_to_handle_at },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_open_by_handle_at },
		{ .entry = &syscall_clock_adjtime },
		{ .entry = &syscall_syncfs },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_sendmmsg },
/* 375 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_setns },
		{ .entry = &syscall_process_vm_readv },
		{ .entry = &syscall_process_vm_writev },
{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_kcmp },
...
/* 385 */	{ .entry = &syscall_ni_syscall },//{ .entry = &syscall_memfd_create },
		{ .entry = &syscall_bpf },
};
