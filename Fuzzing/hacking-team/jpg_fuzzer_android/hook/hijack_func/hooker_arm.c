...
static int ip_register_offset = 0x8;

void* (*no_proto_arm_ptr)(void* a, void* b, void* c, void* d, void* e, void* f, void* g, void* h, void* i, void* j, void* k, void* l, void* m, void* n, void* o, void* p, void* q, void* r, void* s, void* t, void* u, void* w );
...
void*  no_proto_arm(void* a, void* b, void* c, void* d, void* e, void* f, void* g, void* h, void* i, void* j, void* k, void* l, void* m, void* n, void* o, void* p, void* q, void* r, void* s, void* t, void* u, void* w) {
  ...
  asm("mov %[ip], ip" : [ip] "=r" (ip_var) ); //original address in r12 - 0x8  
  ...
  no_proto_arm_ptr = (void *) hook_no_proto->orig;

  if(LOCK_DEBUG)
    log("executing %x from tid %d\n", no_proto_arm_ptr, gettid());
  ...
  result = no_proto_arm_ptr(  a,  b,  c,  d,  e,  f,  g,  h,  i,  j,  k,  l,  m,  n,  o,  p,  q,  r,  s,  t,  u,  w  );
